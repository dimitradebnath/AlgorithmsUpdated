		...
		int number=sc.nextInt();
			...
			switch(number)//stopwatch logic according to choice
			{
				case 1: 
					...
					System.out.println("Time taken during insertion sort of two numbers"+totalTime);
					...
					System.out.println("Time taken during insertion sort of two Strings"+totalTime2);
					...
					System.out.println("Time taken during bubble sort of two numbers"+totalTime3);
					break;   
				case 4: 
					...
					System.out.println("Time taken during bubble sort of two strings"+totalTime4);
					break;
    			 	case 5: 
					...
					System.out.println("Time taken during binary search of two strings"+totalTime6);
					break;
